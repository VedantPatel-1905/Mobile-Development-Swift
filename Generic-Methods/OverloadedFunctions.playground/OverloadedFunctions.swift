...
// HERE CODE LOGIC REMAINS SAME
// If you sort, search, print, swap, minimum, maxmum etc.. in all these operations, your code logic remains same.
// Then WHY NOT CONVERT ALL the OVERLOADED definitions into the generic ones..
