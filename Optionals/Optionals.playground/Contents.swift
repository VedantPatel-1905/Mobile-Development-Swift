...
// That variable is not yet assigned any value and it does not complain.
...
userName="Sujeet"
print(userName)
// Int -- this is Integer type, Int? - this is Integer Optional. Data type followed by "?" makes that type as optional.
// You need to use ! operator to unwrap a value of an optional
//.... Optionals
// Int?, Double?
...
//...EXAMPLE 02.... WHAT IS AN OPTIONAL BINDING?
...
// use of if let with Optionals, theError is let constant

var errorCodeString2: String?
errorCodeString2 = "an error occurred"
if let theError = errorCodeString2 { // no unwrapping is needed here
    print(theError) // no unwrapping of the value is required. This is an advantage
}
else
    {
    print("No Error")
...
// Do you see any output from example 05 -- NO
