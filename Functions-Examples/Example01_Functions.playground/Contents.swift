...
// I can use alias for the argument name
...
print("Ver 4.0 Maximum of 11.1, 13.3 and 12.2 is: \(maximum4(x: 11.1, y: 13.3, z: 12.2))")
print("Ver 4.0 Maximum of 12.2, 11.1 and 13.3 is: \(maximum4(x:12.2, y:11.1, z:13.3))")
...
// Uses underscore character "_" for not specifying the parameter name in the function call
