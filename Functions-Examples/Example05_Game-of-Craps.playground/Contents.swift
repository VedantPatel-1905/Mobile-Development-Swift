...
- On the first roll if a player get either of 4,5,6,8,9 or 10, then that become his point and he will roll the dice again and keep rolling it again and again till he gets his point value. e.g. if he gets 8, then he will keep rolling unless and until he gets 8 again During that time if he gets 7 then he will loose. ( though he wins 7 on the first roll.)
